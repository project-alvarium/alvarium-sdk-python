...
from alvarium.annotators.handler.contracts import CONTENT_LENGTH, CONTENT_TYPE, HTTP_REQUEST_KEY, DerivedComponent
...
class TestPkiHttp(unittest.TestCase):
    ...
    def test_httppki_execute_valid_test(self):
        ...
        ctx = ImmutablePropertyBag({HTTP_REQUEST_KEY: self.request})
    ...
    def test_httppki_execute_invalid_algorithm_test(self):
        ...
        ctx = ImmutablePropertyBag({HTTP_REQUEST_KEY: modified_request})
